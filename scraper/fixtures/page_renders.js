...
async function renderOnce(label, withRuntime) {
  ...
  try {
    ...
    } else if (!['Load', 'Import'].every(l => [...win.document.querySelectorAll('button')].some(b => b.textContent.trim() === l))) {
      fail(label + ': the opening screen is missing Load or Import — got: '
